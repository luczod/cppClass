...
void find_test()
{
    ...
    // it needs opertor overloding, operator==
...
void replace_test()
{
    ...
    std::replace(vec.begin(), vec.end(), 1, 100); // replace all
    for(auto i : vec) {
        std::cout << i << " ";
    }
    std::cout << std::endl;
...
void string_transform_test()
{
    ...
    std::transform(str1.begin(), str1.end(), str1.begin(), ::toupper); // ::toupper, goblal escope

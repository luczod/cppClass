// Scoped enumeration uses class or struct keywords
#include <iostream>
#include <vector>
...
{
    // It must explicitly cast a variable to its underlying type
...
class Player
{
    // Can access private and protected members of other classes
    // in  which it is declared as a friend.
    friend std::ostream &operator<<(std::ostream &os, const Player &p);

public:
    enum struct Mode { Attack, Defense, Idle };

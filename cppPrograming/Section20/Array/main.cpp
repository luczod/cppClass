// Section 20
// std::array, fixed size, direct element access
#include <algorithm>
#include <array>
#include <iostream>
...
void test1()
{
    ...
    arr1[0] = 1000;    // This does NOT do bounce checking
    arr1.at(1) = 2000; // This does bounce checking
    display(arr1);
...
void test3()
{
    ...
    int *ptr = arr1.data(); // return raw pointer
